...
** Date: 3/20/2023
** Description: goes through a series of 5 tests to ensure linked list is implemented successfully
** Input: enter key to go through tests
** Output: actual and expected output, failed or succeeded
******************************************************/
